	...
	return {
		...
		init : function () {
			...
			function loadDKMB(){
				...
				deleteAllRows();
				//post
				$.get("dsDKTMBJson", {KyThue : _KyThue},
					function (json) {
			...
			function editRow(oTable, nRow) {
				...
				jqTds[9].innerHTML = '<input style="width:80px;" name="MaCanBo" type="text" value="'
					 + aData[9] + '"disabled>';
			...
			function addRow(oTable, nRow) {
				...
				jqTds[7].innerHTML = '<input style="width:90px;" name="SoTien" type="text"  value="'
					 + aData[7] + '"disabled>';
				jqTds[8].innerHTML = '<span style="color:red;">'+'Chờ ghi'+'</span>';
				jqTds[9].innerHTML = '<input style="width:80px;" name="MaCanBo" type="text" value="'
					 + MaCanBo + '"disabled>';
			...
			function saveRow(oTable, nRow) {
				...
				oTable.fnUpdate('<span style="color:red;">'+'Chờ ghi'+'</span>', nRow, 8, false);
			...
			$('#editable-sample button.DialogNNT').live('click', function (e) {
				...
				DialogTable.showFromUrl('get',baseUrl('quanlysothue/Dukienthuemonbai/ChonNguoiNopThueChuaCoThueMonBai'),{KyThue : _KyThue},function(){
