...
class user extends \Application\Entity\user implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'MaUser', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'childrenUser', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'parentUser', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'LoaiUser', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'TenUser', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'Email', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'MatKhau', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'TrangThai', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'dukientruythus', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'dukienmbs', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'dukienthues', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'buttoannothues', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'usernnts', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'coquanthue', '' . "\0" . 'Application\\Entity\\user' . "\0" . 'usernntDangHoatDong');
        }
