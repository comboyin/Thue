 ...
 */
class nganh extends \Application\Entity\nganh implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (nganh $proxy) {
    ...
    public function getMaNganh()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMaNganh', array());

        return parent::getMaNganh();
    }
    ...
    public function getTenNganh()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTenNganh', array());

        return parent::getTenNganh();
    }
    ...
    public function setMaNganh($MaNganh)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMaNganh', array($MaNganh));

        return parent::setMaNganh($MaNganh);
    }
